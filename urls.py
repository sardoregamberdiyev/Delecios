...
from dashboard.suggesition import views as suggest_views
...
urlpatterns = [
    ...
    path('suggestions/list/', suggest_views.list, name='suggest_list'),
    path('suggestions/one/<int:pk>/', suggest_views.one, name='suggest_one'),
    path('suggestions/add/', suggest_views.add, name='suggest_add'),
    path('suggestions/del/<int:pk>/', suggest_views.delete, name='suggest_del'),
    path('suggestions/edit/<int:pk>/', suggest_views.edit, name='suggest_edit'),
]
